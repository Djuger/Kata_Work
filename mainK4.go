...
const (
	...
	HIGH  = "Ошибка, неверный формат математической операции "
	SCALE = "Ошибка, разные системы счисления."
	DIV   = "Ошибка, в римской с.с нет отрицательных чисел."
	ZERO  = "Ошибки, римской с.с. нет числа 0."
	RANGE = "Ошибка, разные форматы с.с."
)
